...
crime_selections = html.Div([
    ...
    dcc.RadioItems(
        id='descriptive_crime', labelStyle={'display': 'block'},
    ),
...
], style={'color': '#C0C0C0', 'background': '#161A1D'})
...
crime_container = html.Div([
    ...
    html.Div(crime_selections, id='menu', style={"width": 250, "margin": 10, 'display': 'inline-block'}),
    html.Div(crime_cat_graph, id='main_category', style={"width": 400, "margin": 10, 'display': 'inline-block'}),
    html.Div(crime_occur_graph, id='category_subclasses', style={"width": 400, "margin": 10, 'display': 'inline-block'}),
...
@app.callback(
    [Output('descriptive_crime', 'value')],
    [Input('descriptive_crime', 'options')])
